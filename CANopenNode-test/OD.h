...
/* canopen-sdo test entries (added by hand for segmented SDO transfers) */
#define OD_LEN_X2000_TEST_STRING 64
#define OD_LEN_X2001_TEST_BUFFER 256
...
typedef struct {
    ...
    /* canopen-sdo test entries: large enough to force segmented SDO transfers. */
    char x2000_testString[OD_LEN_X2000_TEST_STRING];
    uint8_t x2001_testBuffer[OD_LEN_X2001_TEST_BUFFER];
} OD_RAM_t;
...
#define OD_ENTRY_H2000_testString &OD->list[33]
#define OD_ENTRY_H2001_testBuffer &OD->list[34]
